 ...
 * add or link Refseq.fa to metannotate/data/. Refseq.fa is a fasta file of the reference proteome to use. This file can be generated by downloading and concatenating the appropriate .faa files from ftp://ftp.ncbi.nlm.nih.gov/refseq/release/ . This file can also be generated from NCBI blastdb files that you may already have on your computer.
 ...
 * cd metannotate/
 * metagenome_directories_root.txt contains the root path for all metagenome directories that will be read by the program. metagenome_directories.txt lists all the directories in that root directory that should be read as metagenome directories (in the case that you have other directories in the root directory that shouldn't be interpreted as metagenome directories). Since this is unique to each system, sample files are provided  which show the necessary format.
 * cp metagenome_directories_root_sample.txt metagenome_directories_root.txt
 * vim metagenome_directories_root.txt (ie. edit as needed).
 * cp metagenome_directories_sample.txt metagenome_directories.txt
 * vim metagenome_directories.txt (ie. edit as needed)
